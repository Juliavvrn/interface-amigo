        ...
        tables: [
          {
            ...
            rows: [
              ...
              [L('se', 'se'), L('Metacognition', 'Метакогниция'), L('Cognitive', 'Когнитивная'), L('Self-checking; reduces impulsiveness, adds self-corrections.', 'Самопроверка; снижает импульсивность, добавляет自self-коррекции.')],
